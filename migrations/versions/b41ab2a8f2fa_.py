...
Revision ID: b41ab2a8f2fa
Revises: 
Create Date: 2023-09-05 15:13:34.150358
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['favourite_film'], ['film.id'], ),
    sa.ForeignKeyConstraint(['favourite_person'], ['person.id'], ),
    sa.ForeignKeyConstraint(['favourite_planet'], ['planet.id'], ),
    sa.ForeignKeyConstraint(['favourite_starship'], ['starship.id'], ),
    sa.ForeignKeyConstraint(['favourite_vehicle'], ['vehicle.id'], ),
